...
public class Movie implements Sequenceable<Movie> {
	...
	/**
	 * Sets the previous Functioning.Movie in the series, and updates the prequel and sequel information of all related movies
	 * involved.
	 *
	 * @param pMovie
	 *            the Functioning.Movie object to set as previous
	 * @pre pMovie != null
	 */
